...
start_miner() {
    tmux new-session -d -s rigel './rigel -a xelishash -o stratum+tcp://us.vipor.net:5077 -u xel:0snx73d8sx7w64qgaex2q6wmwkzs93nuc8sw4nzgz7tstagw0c3sqza8w93 -w MG --log-file logs/miner.log'
}
